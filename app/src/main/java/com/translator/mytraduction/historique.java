...
public class historique extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /**Toolbar toolbar historique**/
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        /**  Inti   FloatingActionButton fab (recherche)**/
...
*/
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.btn_nav_rechercher) {
            ...
            Intent intent1 = new Intent(historique.this, connexion.class);
            startActivity(intent1);


        } else if (id == R.id.btn_nav_historique) {
            Intent intent2 = new Intent(historique.this,historique.class);
            startActivity(intent2);

        } else if (id == R.id.btn_nav_favorite) {
            Intent intent3 = new Intent(historique.this,favorite.class);
